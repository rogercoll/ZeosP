...
SYSOBJ = interrupt.o entry.o sys_call_table.o io.o sched_ass.o sched.o sys.o mm.o devices.o utils.o hardware.o list.o

LIBZEOS = -L . -l zeos

#add to USROBJ the object files required to complete the user program
USROBJ = wrappers.o libc.o # libjp.a
...
sched_ass.s: sched_ass.S $(INCLUDEDIR)/asm.h $(INCLUDEDIR)/segment.h
	$(CPP) $(ASMFLAGS) -o $@ $<
